...
## Private Sector Objectives: Profit Maximization
...
+ Profit maximization means producing at the level of output where the positive difference between total revenue and total costs is greatest.
+ Firms aim to maximize profits by either minimizing costs or maximizing  revenue, or both.
...
+ If one becomes obsolete or one market becomes significantly more compete, then the alternative products or markets will provide a secure source of revenue for the business.  
## Vocabulary
+ Promotion
+ Sales agent
+ Recruitment 
